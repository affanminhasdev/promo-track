...
import 'offer_card_data_model.dart';
export 'offer_card_data_model.dart';

class OfferCardDataWidget extends StatefulWidget {
  const OfferCardDataWidget({
    super.key,
    bool? likeable,
    required this.offer,
    bool? isOwner,
  ...
  @override
  State<OfferCardDataWidget> createState() => _OfferCardDataWidgetState();
}

class _OfferCardDataWidgetState extends State<OfferCardDataWidget> {
  late OfferCardDataModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OfferCardDataModel());
