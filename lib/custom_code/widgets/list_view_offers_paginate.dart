...
class ListViewOffersPaginate extends StatefulWidget {
  const ListViewOffersPaginate({
    super.key,
    this.width,
    this.height,
    this.type,
  ...
  @override
  State<ListViewOffersPaginate> createState() => _ListViewOffersPaginateState();
}

class _ListViewOffersPaginateState extends State<ListViewOffersPaginate> {
  @override
