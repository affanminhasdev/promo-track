...
import 'dialog_offer_details_model.dart';
export 'dialog_offer_details_model.dart';

class DialogOfferDetailsWidget extends StatefulWidget {
  const DialogOfferDetailsWidget({
    super.key,
    required this.offer,
  });
  ...
  @override
  State<DialogOfferDetailsWidget> createState() =>
      _DialogOfferDetailsWidgetState();
}

class _DialogOfferDetailsWidgetState extends State<DialogOfferDetailsWidget>
    with TickerProviderStateMixin {
  late DialogOfferDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DialogOfferDetailsModel());
                          ...
                          Builder(
                            builder: (context) {
                              final offerCategory = FFAppState()
                                  .offerFilterList
                                  .where((e) => e.label == widget!.offer?.type)
                                  .toList();
