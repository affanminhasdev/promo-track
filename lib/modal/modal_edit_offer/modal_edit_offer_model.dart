...
import 'dart:math';
import 'dart:ui';
import 'modal_edit_offer_widget.dart' show ModalEditOfferWidget;
...
class ModalEditOfferModel extends FlutterFlowModel<ModalEditOfferWidget> {
  ...
  // State field(s) for TextField_codepromo widget.
  FocusNode? textFieldCodepromoFocusNode;
  ...
  void dispose() {
    ...
    textFieldCodepromoFocusNode?.dispose();
    textFieldCodepromoTextController?.dispose();
  }
}
