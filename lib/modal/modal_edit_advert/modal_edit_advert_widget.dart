...
import 'modal_edit_advert_model.dart';
export 'modal_edit_advert_model.dart';

class ModalEditAdvertWidget extends StatefulWidget {
  const ModalEditAdvertWidget({
    super.key,
    required this.advertDoc,
  });

  final AdvertRecord? advertDoc;

  @override
  State<ModalEditAdvertWidget> createState() => _ModalEditAdvertWidgetState();
}

class _ModalEditAdvertWidgetState extends State<ModalEditAdvertWidget> {
  late ModalEditAdvertModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalEditAdvertModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.listSelectedOffer =
          widget!.advertDoc!.listOffer.toList().cast<DocumentReference>();
      safeSetState(() {});
    });

    _model.textController1 ??=
        TextEditingController(text: widget!.advertDoc?.name);
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??=
        TextEditingController(text: widget!.advertDoc?.link);
                              ...
                              itemBuilder: (context, listViewIndex) {
                                ...
                                return wrapWithModel(
                                  ...
                                  child: OfferSelectorWidget(
                                    key: Key(
                                      'Keyuvz_${listViewOfferRecord.reference.id}',
                                    ),
                                    offer: listViewOfferRecord,
                                    isSelected: _model.listSelectedOffer
                                            .contains(listViewOfferRecord
                                                .reference) ||
                                        widget!.advertDoc!.listOffer.contains(
              ...
              child: FFButtonWidget(
                onPressed: (() {
                    ...
                    : () async {
                        ...
                        await widget!.advertDoc!.reference.update({
              ...
              child: FFButtonWidget(
                onPressed: (() {
                    ...
                    : () async {
                        ...
                        await widget!.advertDoc!.reference.delete();
                        Navigator.pop(context);
                      },
                text: 'Supprimer',
                options: FFButtonOptions(
