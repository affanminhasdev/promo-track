                        ...
                        children: [
                                      ...
                                      child: Padding(
                                        ...
                                        child: Container(
                                          height: MediaQuery.sizeOf(context)
                                                  .height *
                                              0.8,
                                          child: ModalConfidentialiteWidget(),
                                        ),
                                      ),
                                    );
                                  },
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  width: double.infinity,
                                  decoration: BoxDecoration(
                                    color: Color(0xFF9AA8C3),
                                    boxShadow: [
                                      BoxShadow(
                                        blurRadius: 20.0,
                                        color: Color(0x1A7C7878),
                                        offset: Offset(
                                          0.0,
                                          4.0,
                                        ),
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  onTap: () async {
                                    await launchURL(
                                        'https://www.instagram.com/promotrackfr?igsh=cDd1Y215dXFqZDFh&utm_source=qr');
                                  },
                                  child: ClipRRect(
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    await launchURL(
                                        'https://www.tiktok.com/@promotrackfr?_t=8q9NEohNaee&_r=1');
                                  },
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.asset(
                          ...
                          Align(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/promotrack_logo.png',
                                width: 62.0,
                                height: 62.0,
                                fit: BoxFit.cover,
                              ),
