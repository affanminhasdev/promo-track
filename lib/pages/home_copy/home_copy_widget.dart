                          ...
                          builder: (context, snapshot) {
                            ...
                            return Column(
                              ...
                              children: List.generate(
                                  columnOfferRecordList.length, (columnIndex) {
                                final columnOfferRecord =
                                    columnOfferRecordList[columnIndex];
                                return Visibility(
                                  visible:
                                      (columnOfferRecord.type == _model.type) ||
                                          (_model.type == null ||
                                              _model.type == ''),
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                    ...
                                    child: OfferCardWidget(
                                      key: Key(
                                          'Keyo7o_${columnIndex}_of_${columnOfferRecordList.length}'),
                                      likeable: true,
                                      offer: columnOfferRecord,
                                      isOwner: false,
                                      callback: () async {
                                        await columnOfferRecord.reference
                                            .update({
                                          ...mapToFirestore(
                                            {
                                              'click_nb':
                              ...
                              children: List.generate(
                                ...
                                return Visibility(
                                  ...
                                  child: Padding(
                                    ...
                                    child: OfferCardWidget(
                                      key: Key(
                                          'Keyhsy_${columnIndex}_of_${columnOfferRecordList.length}'),
                                      likeable: true,
                                      offer: columnOfferRecord,
                                      isOwner: false,
                                      callback: () async {
