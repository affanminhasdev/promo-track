...
import 'all_offer_nearby_view_model.dart';
export 'all_offer_nearby_view_model.dart';

class AllOfferNearbyViewWidget extends StatefulWidget {
  const AllOfferNearbyViewWidget({super.key});

  static String routeName = 'AllOfferNearbyView';
  static String routePath = '/allOfferNearbyView';

  @override
  State<AllOfferNearbyViewWidget> createState() =>
      _AllOfferNearbyViewWidgetState();
}

class _AllOfferNearbyViewWidgetState extends State<AllOfferNearbyViewWidget>
    with TickerProviderStateMixin {
  late AllOfferNearbyViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllOfferNearbyViewModel());
                ...
                if (!_model.isLoading)
                  Expanded(
                    child: Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          final offers = (_model.textController.text != null &&
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  OfferLikeWidget(
                                                    key: Key(
                                                        'Keyr2u_${offersIndex}_of_${offers.length}'),
                                                    offer: offersItem.reference,
                                                  ),
                                                ],
                                              ),
                                            ),
